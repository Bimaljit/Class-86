...
let customFonts = {
  "Bubblegum-Sans": require("../assets/fonts/Bubblegum-Sans-regular.ttf")
}
    ...
    if (!this.state.fontsLoaded) {
     ...
     return(
      ...
      <View styles = {styles.container}>
        ...
        <View styles = {styles.cloudContainer}>
          <Image sorce = {require("../assets/cloud.png")}>
            
            styles = {styles.cloudImage}
